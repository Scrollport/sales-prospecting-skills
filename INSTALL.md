---
name: sales-skill-install
description: >-
  Install and prepare the published Scrollport Skills in the Sales and
  prospecting package. Use when a setup prompt names this package.
license: MIT
---
...
[Sales and prospecting repository](https://github.com/Scrollport/sales-prospecting-skills), connects
...
```sh
gh skill install Scrollport/sales-prospecting-skills skills/<skill-id> --pin <source-ref> --agent <agent> --scope <project-or-user>
```
...
```sh
npx skills add https://github.com/Scrollport/sales-prospecting-skills/tree/<source-ref>/skills/<skill-id> --skill <skill-id> --agent <agent>
```
